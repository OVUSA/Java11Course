...
public class BPTrend{
    ...
    public void readData(String fileName) { // reading data from the File
        ...
        try{
            ...
            while(true){
                ...
                if(line == null){  
                    ...
                    entry.pressure = Float.valueOf(wordsArray[2]); // convert from String to a float
    ...
    public String doCalc( String from, String to){
        ...
        +String.format("%.6f",slope) + " \nthe forecast is: ";// that is 6 digits after decimel point
        ...
        if (slope > 0) result = result + " condition are improving\n";
